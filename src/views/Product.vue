                            ...
                            <div class="product-thumbs">
                                <carousel :dots="false" :nav="false" class="product-thumbs-track ps-slider">
                                    ...
                                    <div class="pt" @click="changeImage(thumbs[1])" :class="thumbs[1] == gambar_default ? 'active':''">
                                        <img src="img/KERUDUNG_INSTAN_MASKER_BENTA_2.jpg" alt="" />
                                    </div>

                                    <div class="pt" @click="changeImage(thumbs[2])" :class="thumbs[2] == gambar_default ? 'active':''">
                                        <img src="img/KERUDUNG_INSTAN_MASKER_BENTA_3.jpg" alt="" />
                                    </div>
...
export default {
  ...
  data() {
      return{
          gambar_default :"img/KERUDUNG_INSTAN_MASKER_BENTA_1.jpg",
          thumbs: [
              "img/KERUDUNG_INSTAN_MASKER_BENTA_1.jpg",
              "img/KERUDUNG_INSTAN_MASKER_BENTA_2.jpg",
              "img/KERUDUNG_INSTAN_MASKER_BENTA_3.jpg",
              "img/KERUDUNG_INSTAN_MASKER_BENTA_2.jpg"
          ]
      }
  },
